...
public class NotificacionController {
    ...
    @PostMapping
    public ResponseEntity<Void> crearNotificacion(@RequestBody CrearNotificacionRequest request) {
        notificacionService.crearNotificacion(request);
        return ResponseEntity.status(HttpStatus.CREATED).build();
    }

    @PostMapping("/pedido")
    public ResponseEntity<Void> crearNotificacionConPedido(@RequestBody CrearNotificacionConPedidoRequest request) {
